...
/**
 * Renders ALL session tabs at once (keep-alive strategy).
 * Visibility is controlled by CSS `hidden` class so xterm.js instances
 * are never destroyed on tab switch.
 */
